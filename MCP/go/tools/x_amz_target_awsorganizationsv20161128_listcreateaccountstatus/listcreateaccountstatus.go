...
func ListcreateaccountstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListCreateAccountStatusRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListCreateAccountStatus%s", cfg.BaseURL, queryString)
		...
		var result models.ListCreateAccountStatusResponse
...
func CreateListcreateaccountstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_ListCreateAccountStatus",
		...
		mcp.WithString("States", mcp.Description("")),
		mcp.WithString("MaxResults", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListcreateaccountstatusHandler(cfg),
	}
}
