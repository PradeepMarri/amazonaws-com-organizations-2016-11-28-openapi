...
func ListaccountsforparentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListAccountsForParentRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListAccountsForParent%s", cfg.BaseURL, queryString)
		...
		var result models.ListAccountsForParentResponse
...
func CreateListaccountsforparentTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListaccountsforparentHandler(cfg),
	}
}
