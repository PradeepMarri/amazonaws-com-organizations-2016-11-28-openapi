...
func DeleteresourcepolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.DeleteResourcePolicy", cfg.BaseURL)
...
func CreateDeleteresourcepolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_DeleteResourcePolicy",
		mcp.WithDescription("<p>Deletes the resource policy from your organization.</p> <p>You can only call this operation from the organization's management account.</p>"),
