...
func CreatepolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreatePolicyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.CreatePolicy", cfg.BaseURL)
...
func CreateCreatepolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_CreatePolicy",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatepolicyHandler(cfg),
	}
}
