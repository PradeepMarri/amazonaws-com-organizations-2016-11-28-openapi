...
func ListpoliciesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListPoliciesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListPolicies%s", cfg.BaseURL, queryString)
...
func CreateListpoliciesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_ListPolicies",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListpoliciesHandler(cfg),
	}
}
