...
func CreateaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.CreateAccount", cfg.BaseURL)
		...
		var result models.CreateAccountResponse
...
func CreateCreateaccountTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_CreateAccount",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateaccountHandler(cfg),
	}
}
