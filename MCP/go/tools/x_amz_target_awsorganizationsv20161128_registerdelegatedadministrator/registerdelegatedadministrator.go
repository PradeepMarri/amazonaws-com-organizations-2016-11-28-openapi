...
func RegisterdelegatedadministratorHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RegisterDelegatedAdministratorRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.RegisterDelegatedAdministrator", cfg.BaseURL)
...
func CreateRegisterdelegatedadministratorTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    RegisterdelegatedadministratorHandler(cfg),
	}
}
