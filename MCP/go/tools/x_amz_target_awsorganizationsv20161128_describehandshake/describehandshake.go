...
func DescribehandshakeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeHandshakeRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.DescribeHandshake", cfg.BaseURL)
		...
		var result models.DescribeHandshakeResponse
...
func CreateDescribehandshakeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_DescribeHandshake",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribehandshakeHandler(cfg),
	}
}
