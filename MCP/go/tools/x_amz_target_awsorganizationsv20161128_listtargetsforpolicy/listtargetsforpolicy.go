...
func ListtargetsforpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListTargetsForPolicyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListTargetsForPolicy%s", cfg.BaseURL, queryString)
		...
		var result models.ListTargetsForPolicyResponse
...
func CreateListtargetsforpolicyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListtargetsforpolicyHandler(cfg),
	}
}
