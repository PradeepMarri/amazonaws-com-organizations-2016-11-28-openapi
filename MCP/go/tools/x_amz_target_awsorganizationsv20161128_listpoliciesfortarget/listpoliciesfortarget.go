...
func ListpoliciesfortargetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListPoliciesForTargetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListPoliciesForTarget%s", cfg.BaseURL, queryString)
		...
		var result models.ListPoliciesForTargetResponse
...
func CreateListpoliciesfortargetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_ListPoliciesForTarget",
		...
		mcp.WithString("Filter", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListpoliciesfortargetHandler(cfg),
	}
}
