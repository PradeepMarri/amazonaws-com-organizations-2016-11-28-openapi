...
func DeregisterdelegatedadministratorHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeregisterDelegatedAdministratorRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.DeregisterDelegatedAdministrator", cfg.BaseURL)
...
func CreateDeregisterdelegatedadministratorTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSOrganizationsV20161128_DeregisterDelegatedAdministrator",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeregisterdelegatedadministratorHandler(cfg),
	}
}
