...
func ListhandshakesfororganizationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListHandshakesForOrganizationRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListHandshakesForOrganization%s", cfg.BaseURL, queryString)
		...
		var result models.ListHandshakesForOrganizationResponse
...
func CreateListhandshakesfororganizationTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListhandshakesfororganizationHandler(cfg),
	}
}
