...
func ListhandshakesforaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListHandshakesForAccountRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSOrganizationsV20161128.ListHandshakesForAccount%s", cfg.BaseURL, queryString)
		...
		var result models.ListHandshakesForAccountResponse
...
func CreateListhandshakesforaccountTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListhandshakesforaccountHandler(cfg),
	}
}
